<div class="col-md-9">
	<div class="content-box-large">
		<div class="panel-heading">
			<div class="panel-title"><i class="glyphicon glyphicon-plus"></i> Edit Kas Masuk</div>
		</div>
		<div class="panel-body">
			<form class="form-horizontal" role="form" action="?editedKasmasuk" method="post">
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<input type="text" name="tanggal" class="form-control" id="tanggal" placeholder="Tanggal Transfer">
					</div>
				</div>
				<div class="form-group">
